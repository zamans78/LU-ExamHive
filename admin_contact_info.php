...
<body>
  ...
  <main>
    <div class="container">
      ...
      <div class="row">
        <div class="col"></div>
        <div class="col-xl-9 col-lg-9 col-md-10 col-sm-9 col-xs-6 my-5 table-responsive-sm">
          ...
          <table class="table table-hover">
            ...
            <?php foreach ($infos as $info) {?>
              ...
              <tr onclick="window.location='admin_contact_details.php?id=<?php echo $info['ID'] ?>';">
                ...
                <td><a href="admin_contact_details.php?id=<?php echo $info['ID'] ?>">More info</a></td>
              </tr>
