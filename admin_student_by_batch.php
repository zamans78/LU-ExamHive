...
if (isset($_GET['batch'])) {
  ...
  $stmt = $pdo->query("SELECT * from Student WHERE Batch = $batch");
  $infos = $stmt->fetchAll(PDO::FETCH_ASSOC);

  $stmt2 = $pdo->query("SELECT COUNT(Section), Section from Student WHERE Batch = $batch GROUP BY Section");
      ...
      <div class="col"></div>
        ...
        <table class="table text-center">
            ...
            <?php foreach ($sections as $sec){ ?>
                ...
                <td><a href="">Sec: <?php echo htmlspecialchars($sec['Section']); ?></a></td>
