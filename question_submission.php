...
<header>
	<nav class="navbar navbar-expand-lg navbar-light sticky-top">
		...
		<a class="navbar-brand" href="index.php"><img id="logo" src="assets/images/LuExamHiveLogo.png" height="30px"> LU EXAM HIVE</a>
			<a type="button" href="question_view.php?Question_Description_ID=<?php echo $q_id; ?>" class="btn btn-sm btn-outline-dark ml-3"><i class="fas fa-arrow-left"></i> Go Back</a>
		</div>
	</nav>
</header>
